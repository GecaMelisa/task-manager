...
{
    /**
     * Get the database connection for admin tables.
     */
    ...
    /**
     * Run the migrations to create admin-related tables.
     */
    public function up()
    {
        // Admin users table
        ...
        // Pivot tables for role-based access control
    ...
    /**
     * Reverse the migrations by dropping admin tables.
     */
